...
struct ContractThumbnailView: View {
    let fileURL: URL
    let patient: Patient
    let onTap: () -> Void
    let onDelete: () -> Void
...
//                    .alert(NSLocalizedString("deleteContract", comment: "Delete contract"), isPresented: $showDeleteConfirmation) {
...
//                    } message: {
//                        Text(NSLocalizedString("reallyDeleteContract", comment: "Really delete contract?"))
//                    }
            }
        }
        if showToast {
    ...
    private func sendEmail(with originalURL: URL, for patient: Patient) {
        ...
        let localizedName = NSLocalizedString("contractFilename", comment: "Behandlungsvertrag")
        ...
        func presentMailComposer(to recipient: String) {
            ...
            let subject = patient.firstnameTerms
                    ? NSLocalizedString("contractSubjectFirstnameTerms", comment: "")
                    : NSLocalizedString("contractSubject", comment: "")
            ...
            let agreementBody = patient.firstnameTerms
                    ? NSLocalizedString("contractBodyFirstnameTerms", comment: "")
                    : NSLocalizedString("contractBodyFirstnameTerms", comment: "")
