...
struct SymptomsEntryList: View {
    @Binding var entries: [SymptomsStatusEntry]
    let titleKey: String
    ...
    var body: some View {
                ...
                ForEach(Array(entries.indices), id: \.self) { idx in
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        HStack {
                            ...
                            .frame(maxWidth: 250)
                            .onChange(of: entryBinding.side.wrappedValue) { _, _ in onEdited() }
        ...
        .alert(isPresented: $showDeleteAlert) {
            Alert(
                ...
                message: Text(
                    NSLocalizedString(
                        "reallyDeleteSymptomEntry",
                        comment: "Really delete symptom entry"
                    )
                ),
